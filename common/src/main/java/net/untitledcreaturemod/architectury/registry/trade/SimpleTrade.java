...
package net.untitledcreaturemod.architectury.registry.trade;
 ...
 * All trades added by vanilla do have custom classes like {@link TradeOffers.BuyForOneEmeraldFactory}, but they aren't accessible.
 * <p>
 ...
 * {@link TradeRegistry#registerVillagerTrade(net.minecraft.village.VillagerProfession, int, TradeOffers.Factory...)}
 * or
 * {@link TradeRegistry#registerTradeForWanderingTrader(boolean, TradeOffers.Factory...)}.
 */
public class SimpleTrade implements TradeOffers.Factory {
     ...
     * You can take a look at all the values the vanilla game uses right here {@link TradeOffers#PROFESSION_TO_LEVELED_TRADE}.
     *
    ...
    public TradeOffer create(Entity entity, Random random) {
        return new TradeOffer(this.primaryPrice, this.secondaryPrice, this.sale, this.maxTrades, this.experiencePoints, this.priceMultiplier);
    }
}
