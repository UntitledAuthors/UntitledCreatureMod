...
public class TradeRegistry {
    ...
    /**
     * Register a trade ({@link TradeOffers.Factory}) for a villager by its profession and level.
     ...
     */
    public static void registerVillagerTrade(VillagerProfession profession, int level, TradeOffers.Factory... trades) {
        if (level < 1) {
    ...
    @ExpectPlatform
    private static void registerVillagerTrade0(VillagerProfession profession, int level, TradeOffers.Factory... trades) {
        throw new AssertionError();
    }
    
    /**
     * Register a trade ({@link TradeOffers.Factory}) to a wandering trader by its rarity.
     ...
     */
    @ExpectPlatform
    public static void registerTradeForWanderingTrader(boolean rare, TradeOffers.Factory... trades) {
        throw new AssertionError();
    }
