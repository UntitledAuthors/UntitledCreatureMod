...
public enum Env {
     ...
     *
     * @param type the platform-specific environment enum, could be {@link EnvType} or {@link net.minecraftforge.api.distmarker.Dist}
     ...
     *
     * @return the platform-specific environment enum, could be {@link EnvType} or {@link net.minecraftforge.api.distmarker.Dist}
     */
